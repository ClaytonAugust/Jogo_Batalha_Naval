...
int main() {
    ...
    do {
        ...
        if (player == 1) {
            ...
            printf("Player %d, entre linha e coluna para atirar: ", player);
            scanf(" %c %d", &c, &coluna);
            linha = c - 'A';
            coluna--;
        } else {
            fazerTiroMaquina(player1_board);
            linha = 0; // Valor qualquer, não utilizado para o jogador 2 (máquina).
            coluna = 0; // Valor qualquer, não utilizado para o jogador 2 (máquina).
        }
